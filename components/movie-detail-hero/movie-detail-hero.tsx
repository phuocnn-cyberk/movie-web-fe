...
export const MovieDetailHero: React.FC<MovieDetailHeroProps> = ({ movie }) => {
  ...
  // ✅ MovieDTO không có backgroundImage -> dùng poster & fallback ảnh local
  const bgImage: string =
    (typeof movie?.poster === "string" && movie.poster.trim()) ||
    "/images/hunter-bg.png";
  ...
  return (
    <section className="w-full px-20 py-0">
      {/* Main Container - giữ đúng layout/height/giao diện cũ */}
      <div
        ...
        >
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex items-center gap-3">
              <button className="bg-[#0F0F0F] border border-[#262626] rounded-lg p-[14px] hover:bg-[#1A1A1A] transition-colors duration-200">
